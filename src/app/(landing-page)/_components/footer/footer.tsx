...
function Copyright() {
  return (
    <Typography variant="subtitle2" sx={{ color: "text.secondary", mt: 1 }}>
      {"Copyright © "}
      GPT Deep Research - {new Date().getFullYear()}
    </Typography>
  );
}
      ...
      >
        ...
        >
          <Stack sx={{ width: { xs: "100%", md: "60%" } }} spacing={2}>
            ...
            >
              Experience the next level of AI-assisted research with GPT Deep Research. Save time, gain clarity, and produce high-quality content backed by organized, accurate insights. Dive deeper—faster. Try GPT Deep Research today!
            </Typography>
            <Stack
              direction="row"
              spacing={1}
          ...
          >
            ...
            >
              ...
              <Link
                color="text.secondary"
                variant="subtitle2"
                href="https://docs.google.com/document/d/1t_9Y54GQBbMlAUdnuvj24QVZZdRu2PlxKnaRzPOaZTE/edit?usp=sharing"
              >
                Privacy Policy
              </Link>
              <Link
